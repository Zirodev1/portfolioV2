...
// Create and export the EditorContext
export const EditorContext = createContext({});

// Blog editor initial state
...
// BlogEditor component for creating/editing blog posts
export const BlogEditor = () => {
  const [blog, setBlog] = useState(initialBlogState);
  const [textEditor, setTextEditor] = useState(null);
  const [editorState, setEditorState] = useState("editor"); // editor, publish, save-draft
...
const EditProfile = () => {
  ...
  useEffect(() => {
    if (accessToken) {
      axios
        .post(`${import.meta.env.VITE_API_URL}/get-profile`, {
      ...
      uploadImage(updatedProfileImg)
        .then((url) => {
          if (url) {
            axios
              .post(
                `h${import.meta.env.VITE_API_URL}/update-profile-img`,
                { url },
                {
                  headers: {
